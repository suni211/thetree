...
const require$$1 = /* @__PURE__ */ server.getAugmentedNamespace(sortable_esm);
...
function requireVuedraggable_umd() {
  ...
  (function(module2, exports2) {
    (function webpackUniversalModuleDefinition(root, factory) {
      module2.exports = factory(server.requireVue_cjs_prod(), require$$1);
...
const draggable = /* @__PURE__ */ server.getDefaultExportFromCjs(vuedraggable_umdExports);
const aclNames = {
  read: "읽기",
  edit: "편집",
  move: "이동",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_draggable = server.vueExports.resolveComponent("draggable");
  ...
  _push(`<div data-v-06a99973><h4 data-v-06a99973>${server.serverRenderer_cjs_prodExports.ssrInterpolate($options.activeAclType.title)}</h4><div class="acl-table" data-v-06a99973><table data-v-06a99973><colgroup data-v-06a99973><col style="${server.serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "60px" })}" data-v-06a99973><col data-v-06a99973><col style="${server.serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "80px" })}" data-v-06a99973><col style="${server.serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "200px" })}" data-v-06a99973><col style="${server.serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "60px" })}" data-v-06a99973></colgroup><thead data-v-06a99973><tr data-v-06a99973><th data-v-06a99973>No</th><th data-v-06a99973>Condition</th><th data-v-06a99973>Action</th><th data-v-06a99973>Expiration</th><th data-v-06a99973></th></tr></thead>`);
  if ($data.rules.length) {
    _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_draggable, {
      ...
      item: server.vueExports.withCtx(({ element, index: index2 }, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<tr data-v-06a99973${_scopeId}><td data-v-06a99973${_scopeId}>${server.serverRenderer_cjs_prodExports.ssrInterpolate(index2 + 1)}</td><td data-v-06a99973${_scopeId}>${server.serverRenderer_cjs_prodExports.ssrInterpolate(element.condition)}</td><td data-v-06a99973${_scopeId}>${element.action ?? ""}</td><td data-v-06a99973${_scopeId}>`);
          ...
          _push2(`</td><td data-v-06a99973${_scopeId}>`);
          if ($options.editable) {
          ...
          return [
            server.vueExports.createVNode("tr", null, [
              server.vueExports.createVNode("td", null, server.vueExports.toDisplayString(index2 + 1), 1),
              server.vueExports.createVNode("td", null, server.vueExports.toDisplayString(element.condition), 1),
              server.vueExports.createVNode("td", {
                innerHTML: element.action
              }, null, 8, ["innerHTML"]),
              server.vueExports.createVNode("td", null, [
                element.expiresAt ? (server.vueExports.openBlock(), server.vueExports.createBlock(_component_LocalDate, {
                  key: 0,
                  date: element.expiresAt
                }, null, 8, ["date"])) : (server.vueExports.openBlock(), server.vueExports.createBlock(server.vueExports.Fragment, { key: 1 }, [
                  server.vueExports.createTextVNode("영구")
                ], 64))
              ]),
              server.vueExports.createVNode("td", null, [
                $options.editable ? (server.vueExports.openBlock(), server.vueExports.createBlock(_component_SeedButton, {
                  key: 0,
                  danger: "",
                  onClick: ($event) => $options.deleteRule(element)
                }, {
                  ...
                  _: 2
                }, 1032, ["onClick"])) : server.vueExports.createCommentVNode("", true)
              ])
            ])
          ];
        }
    ...
    _push(`<tbody data-v-06a99973><tr data-v-06a99973><td colspan="5" data-v-06a99973>`);
    if ($options.aclCategory === "thread") {
      _push(`<!--[--> (규칙이 존재하지 않습니다. `);
      _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
        to: "#document." + $options.aclType
      }, {
        default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              server.vueExports.createTextVNode("문서 ACL")
            ];
          }
        }),
        _: 1
      ...
      _push(`이 적용됩니다.) <!--]-->`);
    } else if ($options.aclCategory === "document") {
      _push(`<!--[--> (규칙이 존재하지 않습니다. `);
      _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
        to: "#namespace." + $options.aclType
      }, {
        default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`이름공간 ACL`);
            ...
            return [
              server.vueExports.createTextVNode("이름공간 ACL")
            ];
          }
        }),
        _: 1
  ...
  if ($options.editable) {
    _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_SeedForm, {
      ...
      default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          if (_ctx.data.thread) {
            _push2(`<input type="hidden" name="thread"${server.serverRenderer_cjs_prodExports.ssrRenderAttr("value", _ctx.data.thread.url)} data-v-06a99973${_scopeId}>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<input type="hidden" name="target"${server.serverRenderer_cjs_prodExports.ssrRenderAttr("value", $options.aclCategory)} data-v-06a99973${_scopeId}><input type="hidden" name="aclType"${server.serverRenderer_cjs_prodExports.ssrRenderAttr("value", $options.aclType === "acl" ? "ACL" : _ctx.snakeToCamelCase($options.aclType))} data-v-06a99973${_scopeId}><div class="acl-edit-group not-group" data-v-06a99973${_scopeId}><label data-v-06a99973${_scopeId}>not</label><div data-v-06a99973${_scopeId}>`);
          _push2(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_CheckBox, {
            name: "not",
            value: "Y"
          }, null, _parent2, _scopeId));
          _push2(`</div></div><div class="acl-edit-group" data-v-06a99973${_scopeId}><label data-v-06a99973${_scopeId}>Condition</label><div data-v-06a99973${_scopeId}><select name="conditionType" data-v-06a99973${_scopeId}><option value="Perm" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.conditionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.conditionType, "Perm") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.conditionType, "Perm")) ? " selected" : ""}${_scopeId}>권한</option><option value="User" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.conditionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.conditionType, "User") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.conditionType, "User")) ? " selected" : ""}${_scopeId}>사용자</option><option value="IP" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.conditionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.conditionType, "IP") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.conditionType, "IP")) ? " selected" : ""}${_scopeId}>아이피</option><option value="GeoIP" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.conditionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.conditionType, "GeoIP") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.conditionType, "GeoIP")) ? " selected" : ""}${_scopeId}>GeoIP</option><option value="ACLGroup" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.conditionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.conditionType, "ACLGroup") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.conditionType, "ACLGroup")) ? " selected" : ""}${_scopeId}>ACL그룹</option></select>`);
          if ($data.form.conditionType === "Perm") {
            _push2(`<!--[--><select${server.serverRenderer_cjs_prodExports.ssrRenderAttr("name", $data.form.permissionSelect === "custom" ? null : "permission")} data-v-06a99973${_scopeId}><option value="any" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "any") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "any")) ? " selected" : ""}${_scopeId}>아무나</option><option value="ip" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "ip") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "ip")) ? " selected" : ""}${_scopeId}>아이피 사용자</option><option value="member" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "member") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "member")) ? " selected" : ""}${_scopeId}>로그인된 사용자</option><option value="admin" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "admin") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "admin")) ? " selected" : ""}${_scopeId}>관리자</option><option value="member_signup_15days_ago" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "member_signup_15days_ago") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "member_signup_15days_ago")) ? " selected" : ""}${_scopeId}>가입한지 15일 지난 사용자</option><option value="document_contributor" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "document_contributor") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "document_contributor")) ? " selected" : ""}${_scopeId}>해당 문서 기여자</option><option value="contributor" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "contributor") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "contributor")) ? " selected" : ""}${_scopeId}>위키 기여자</option><option value="match_username_and_document_title" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "match_username_and_document_title") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "match_username_and_document_title")) ? " selected" : ""}${_scopeId}>문서 제목과 사용자 이름이 일치</option><option value="mobile_verified_member" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "mobile_verified_member") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "mobile_verified_member")) ? " selected" : ""}${_scopeId}>모바일 인증된 사용자</option><option value="auto_verified_member" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "auto_verified_member") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "auto_verified_member")) ? " selected" : ""}${_scopeId}>자동 인증된 사용자</option><option value="custom" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.permissionSelect) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.permissionSelect, "custom") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.permissionSelect, "custom")) ? " selected" : ""}${_scopeId}>직접 입력</option></select>`);
            if ($data.form.permissionSelect === "custom") {
              _push2(`<input name="permission" placeholder="permission" data-v-06a99973${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--]-->`);
          } else {
            _push2(`<input type="text" name="conditionContent" data-v-06a99973${_scopeId}>`);
          }
          _push2(`</div></div><div class="acl-edit-group" data-v-06a99973${_scopeId}><label data-v-06a99973${_scopeId}>Action :</label><div data-v-06a99973${_scopeId}><select name="actionType" data-v-06a99973${_scopeId}><option value="Allow" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.actionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.actionType, "Allow") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.actionType, "Allow")) ? " selected" : ""}${_scopeId}>허용</option><option value="Deny" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.actionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.actionType, "Deny") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.actionType, "Deny")) ? " selected" : ""}${_scopeId}>거부</option>`);
          if ($options.aclCategory !== "namespace") {
            _push2(`<option value="GotoNS" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.actionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.actionType, "GotoNS") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.actionType, "GotoNS")) ? " selected" : ""}${_scopeId}>이름공간ACL 실행</option>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<option value="GotoOtherNS" data-v-06a99973${server.serverRenderer_cjs_prodExports.ssrIncludeBooleanAttr(Array.isArray($data.form.actionType) ? server.serverRenderer_cjs_prodExports.ssrLooseContain($data.form.actionType, "GotoOtherNS") : server.serverRenderer_cjs_prodExports.ssrLooseEqual($data.form.actionType, "GotoOtherNS")) ? " selected" : ""}${_scopeId}>다른 이름공간ACL 실행</option></select>`);
          if ($data.form.actionType === "GotoOtherNS") {
            _push2(`<input name="actionContent" placeholder="namespace" data-v-06a99973${_scopeId}>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div><div class="acl-edit-group" data-v-06a99973${_scopeId}><label data-v-06a99973${_scopeId}>Duration :</label><div data-v-06a99973${_scopeId}>`);
          ...
          return [
            _ctx.data.thread ? (server.vueExports.openBlock(), server.vueExports.createBlock("input", {
              key: 0,
              type: "hidden",
              name: "thread",
              value: _ctx.data.thread.url
            }, null, 8, ["value"])) : server.vueExports.createCommentVNode("", true),
            ...
            server.vueExports.createVNode("div", { class: "acl-edit-group not-group" }, [
              server.vueExports.createVNode("label", null, "not"),
            ...
            server.vueExports.createVNode("div", { class: "acl-edit-group" }, [
              server.vueExports.createVNode("label", null, "Condition"),
              server.vueExports.createVNode("div", null, [
                server.vueExports.withDirectives(server.vueExports.createVNode("select", {
                  ...
                  server.vueExports.createVNode("option", { value: "Perm" }, "권한"),
                  server.vueExports.createVNode("option", { value: "User" }, "사용자"),
                  server.vueExports.createVNode("option", { value: "IP" }, "아이피"),
                  server.vueExports.createVNode("option", { value: "GeoIP" }, "GeoIP"),
                  server.vueExports.createVNode("option", { value: "ACLGroup" }, "ACL그룹")
                ], 8, ["onUpdate:modelValue"]), [
                  [server.vueExports.vModelSelect, $data.form.conditionType]
                ]),
                $data.form.conditionType === "Perm" ? (server.vueExports.openBlock(), server.vueExports.createBlock(server.vueExports.Fragment, { key: 0 }, [
                  server.vueExports.withDirectives(server.vueExports.createVNode("select", {
                    "onUpdate:modelValue": ($event) => $data.form.permissionSelect = $event,
                    name: $data.form.permissionSelect === "custom" ? null : "permission"
                  }, [
                    server.vueExports.createVNode("option", { value: "any" }, "아무나"),
                    server.vueExports.createVNode("option", { value: "ip" }, "아이피 사용자"),
                    server.vueExports.createVNode("option", { value: "member" }, "로그인된 사용자"),
                    server.vueExports.createVNode("option", { value: "admin" }, "관리자"),
                    server.vueExports.createVNode("option", { value: "member_signup_15days_ago" }, "가입한지 15일 지난 사용자"),
                    server.vueExports.createVNode("option", { value: "document_contributor" }, "해당 문서 기여자"),
                    server.vueExports.createVNode("option", { value: "contributor" }, "위키 기여자"),
                    server.vueExports.createVNode("option", { value: "match_username_and_document_title" }, "문서 제목과 사용자 이름이 일치"),
                    server.vueExports.createVNode("option", { value: "mobile_verified_member" }, "모바일 인증된 사용자"),
                    server.vueExports.createVNode("option", { value: "auto_verified_member" }, "자동 인증된 사용자"),
                    server.vueExports.createVNode("option", { value: "custom" }, "직접 입력")
                  ], 8, ["onUpdate:modelValue", "name"]), [
                    [server.vueExports.vModelSelect, $data.form.permissionSelect]
                  ]),
                  $data.form.permissionSelect === "custom" ? (server.vueExports.openBlock(), server.vueExports.createBlock("input", {
                    key: 0,
                    name: "permission",
                    placeholder: "permission"
                  })) : server.vueExports.createCommentVNode("", true)
                ], 64)) : (server.vueExports.openBlock(), server.vueExports.createBlock("input", {
                  key: 1,
                  type: "text",
            ...
            server.vueExports.createVNode("div", { class: "acl-edit-group" }, [
              server.vueExports.createVNode("label", null, "Action :"),
              server.vueExports.createVNode("div", null, [
                server.vueExports.withDirectives(server.vueExports.createVNode("select", {
                  name: "actionType",
                  "onUpdate:modelValue": ($event) => $data.form.actionType = $event
                }, [
                  server.vueExports.createVNode("option", { value: "Allow" }, "허용"),
                  server.vueExports.createVNode("option", { value: "Deny" }, "거부"),
                  $options.aclCategory !== "namespace" ? (server.vueExports.openBlock(), server.vueExports.createBlock("option", {
                    key: 0,
                    value: "GotoNS"
                  }, "이름공간ACL 실행")) : server.vueExports.createCommentVNode("", true),
                  server.vueExports.createVNode("option", { value: "GotoOtherNS" }, "다른 이름공간ACL 실행")
                ], 8, ["onUpdate:modelValue"]), [
                  [server.vueExports.vModelSelect, $data.form.actionType]
                ]),
                $data.form.actionType === "GotoOtherNS" ? (server.vueExports.openBlock(), server.vueExports.createBlock("input", {
                  key: 0,
                  name: "actionContent",
            ...
            server.vueExports.createVNode("div", { class: "acl-edit-group" }, [
              server.vueExports.createVNode("label", null, "Duration :"),
              server.vueExports.createVNode("div", null, [
...
const acl = /* @__PURE__ */ server._export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-06a99973"]]);
exports.default = acl;
