...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<p data-v-1e8b63d2> 다음은 [[`);
  _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
    to: _ctx.doc_action_link($options.frontPage, "w")
  }, {
    default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`${server.serverRenderer_cjs_prodExports.ssrInterpolate($options.frontPage)}`);
      } else {
        return [
          server.vueExports.createTextVNode(server.vueExports.toDisplayString($options.frontPage), 1)
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`]]에서 링크로 도달할 수 없는 문서로, 역링크가 없거나 자기네들끼리만 링크가 되어 있는 경우입니다. </p><p data-v-1e8b63d2>이 페이지는 하루에 한번 업데이트 됩니다.</p>`);
...
const OrphanedPages = /* @__PURE__ */ server._export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1e8b63d2"]]);
exports.default = OrphanedPages;
