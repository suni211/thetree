  ...
  _push(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_SeedForm, {
    ...
    default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<div class="${server.serverRenderer_cjs_prodExports.ssrRenderClass(_ctx.$style.form__row)}"${_scopeId}><p class="${server.serverRenderer_cjs_prodExports.ssrRenderClass(_ctx.$style.text)}"${_scopeId}>30일마다 변경할 수 있습니다.</p></div><div class="${server.serverRenderer_cjs_prodExports.ssrRenderClass([_ctx.$style.form__row, _ctx.$style["form__row--buttons"]])}"${_scopeId}><div class="${server.serverRenderer_cjs_prodExports.ssrRenderClass(_ctx.$style.form__buttons)}"${_scopeId}>`);
        _push2(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_GeneralButton, {
          ...
          default: server.vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              return [
                server.vueExports.createTextVNode("이름 변경")
              ];
            }
          }),
          _: 1
...
const change_name = /* @__PURE__ */ server._export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__cssModules", cssModules]]);
exports.default = change_name;
