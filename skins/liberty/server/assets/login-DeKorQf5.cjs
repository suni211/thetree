...
const _sfc_main = {
  ...
  computed: {
    externalProviders() {
      var _a;
      return (_a = this.data.externalProviders) == null ? void 0 : _a.map((a) => {
  ...
  methods: {
    ...
    async passkeyLogin(auto = false) {
      ...
      let asseResp;
      try {
        asseResp = await startAuthentication.startAuthentication({ optionsJSON: this.data.passkeyData, useBrowserAutofill: true });
      } catch (e) {
    ...
    default: server.vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if (!_ctx.data.disableInternal) {
          ...
          _push2(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_FlexFormBlock, { flexStart: "" }, {
            default: server.vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, { to: "/member/recover_password" }, {
                  default: server.vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`비밀번호를 잊으셨나요?`);
                    } else {
                      return [
                        server.vueExports.createTextVNode("비밀번호를 잊으셨나요?")
                      ];
                    }
                  }),
                  _: 1
                ...
                return [
                  server.vueExports.createVNode(_component_NuxtLink, { to: "/member/recover_password" }, {
          ...
          _push2(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_FlexFormBlock, {
            ...
            buttons: server.vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                if (!_ctx.data.disableSignup) {
                  _push3(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_GeneralButton, { href: "/member/signup" }, {
                    default: server.vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`계정 만들기`);
                      } else {
                        return [
                          server.vueExports.createTextVNode("계정 만들기")
                        ];
                      }
                    }),
                    _: 1
                ...
                return [
                  !_ctx.data.disableSignup ? (server.vueExports.openBlock(), server.vueExports.createBlock(_component_GeneralButton, {
                    key: 0,
                    href: "/member/signup"
                  }, {
                    default: server.vueExports.withCtx(() => [
                ...
                _push3(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_CheckBox, {
                  ...
                  default: server.vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      ...
                      return [
                        server.vueExports.createTextVNode("자동 로그인")
                      ];
                    }
                  }),
                  _: 1
        ...
        if ($options.externalProviders.length) {
          _push2(`<!--[-->`);
          if (!_ctx.data.disableInternal) {
            _push2(`<div class="or" data-v-bc6809f4${_scopeId}>외부 로그인</div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div class="external-login-buttons" data-v-bc6809f4${_scopeId}><!--[-->`);
          server.serverRenderer_cjs_prodExports.ssrRenderList($options.externalProviders, (item) => {
            _push2(server.serverRenderer_cjs_prodExports.ssrRenderComponent(_component_GeneralButton, {
              block: "",
              class: "external-login-button",
              href: `/member/login/oauth2/${item.name}?redirect=${encodeURIComponent(_ctx.$route.query.redirect)}`,
              style: {
              ...
              default: server.vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (item.logo || item.darkLogo) {
                    _push3(`<img${server.serverRenderer_cjs_prodExports.ssrRenderAttr("src", _ctx.$store.state.isDark && item.darkLogo || item.logo || item.darkLogo)} data-v-bc6809f4${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(` ${server.serverRenderer_cjs_prodExports.ssrInterpolate(_ctx.$store.state.isDark && item.darkText || item.text)}`);
                } else {
                  return [
                    item.logo || item.darkLogo ? (server.vueExports.openBlock(), server.vueExports.createBlock("img", {
                      key: 0,
                      src: _ctx.$store.state.isDark && item.darkLogo || item.logo || item.darkLogo
                    }, null, 8, ["src"])) : server.vueExports.createCommentVNode("", true),
                    server.vueExports.createTextVNode(" " + server.vueExports.toDisplayString(_ctx.$store.state.isDark && item.darkText || item.text), 1)
                  ];
                }
              }),
              _: 2
        ...
        _push2(`<input type="hidden" name="redirect"${server.serverRenderer_cjs_prodExports.ssrRenderAttr("value", _ctx.$route.query.redirect)} data-v-bc6809f4${_scopeId}>`);
      } else {
        return [
          !_ctx.data.disableInternal ? (server.vueExports.openBlock(), server.vueExports.createBlock(server.vueExports.Fragment, { key: 0 }, [
            ...
            server.vueExports.createVNode(_component_FlexFormBlock, { flexStart: "" }, {
              default: server.vueExports.withCtx(() => [
                server.vueExports.createVNode(_component_NuxtLink, { to: "/member/recover_password" }, {
                  default: server.vueExports.withCtx(() => [
                    server.vueExports.createTextVNode("비밀번호를 잊으셨나요?")
          ...
          $options.externalProviders.length ? (server.vueExports.openBlock(), server.vueExports.createBlock(server.vueExports.Fragment, { key: 1 }, [
            !_ctx.data.disableInternal ? (server.vueExports.openBlock(), server.vueExports.createBlock("div", {
              key: 0,
              class: "or"
            }, "외부 로그인")) : server.vueExports.createCommentVNode("", true),
            server.vueExports.createVNode("div", { class: "external-login-buttons" }, [
              (server.vueExports.openBlock(true), server.vueExports.createBlock(server.vueExports.Fragment, null, server.vueExports.renderList($options.externalProviders, (item) => {
                return server.vueExports.openBlock(), server.vueExports.createBlock(_component_GeneralButton, {
                  block: "",
                  class: "external-login-button",
                  href: `/member/login/oauth2/${item.name}?redirect=${encodeURIComponent(_ctx.$route.query.redirect)}`,
                  style: {
...
const login = /* @__PURE__ */ server._export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-bc6809f4"]]);
